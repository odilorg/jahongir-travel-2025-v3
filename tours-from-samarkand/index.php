								...
								<div class="item_border item-product">
									<div class="post_images">
										<a href="yurt-camp-tour.php">
											...
											<img width="430" height="305" src="images/yurt-camp-aydarkul/yurt-camp-aydarkul.jpg" alt="yurt-camp-aydarkul-tour-from-samarkand" title="yurt-camp-aydarkul-tour-from-samarkand">
										</a>
									...
									<div class="wrapper_content">
										...
										<div class="description">
											<p>Spend an unforgettable night under the desert stars in this adventurous trip to Aydatkul lake in the middle of the Desert. Along the way you will experience the wild life of the deserts and the historical monuments dated back the thousands of years in the period of Alexander the Great invasion.</p>
										</div>
									</div>
									<div class="read_more">
							...
							<li class="item-tour col-md-4 col-sm-6 product">
								<div class="item_border item-product">
									...
									<div class="wrapper_content">
										...
										<span class="post_date">2 DAYS 1 NIGHT</span>
										<div class="description">
											<p>This two days trip to Nuratau Mountains offers you a chance to experience rural homestay with the mountain farmer family in the remote village of Nuratau Mountains and get to know about their daily life, traditions and customs. You will also explore the mountains, it’s flora and fauna and some local sites during short walks around the village.</p>
										</div>
									</div>
									<div class="read_more">
										<div class="item_rating">
							...
							<li class="item-tour col-md-4 col-sm-6 product">
								<div class="item_border item-product">
									...
									<div class="wrapper_content">
										...
										<div class="description">
											<p>Embark on an unforgettable journey through the breathtaking landscapes of Central Asia with our Tajikistan Seven Lakes Day Tour from Samarkand. Begin your adventure by exploring the ancient wonders of Penjikent and Sarazm, two UNESCO World Heritage Sites rich in history and culture.</p>
										</div>
									</div>
									<div class="read_more">
										<div class="item_rating">
							...
							<li class="item-tour col-md-4 col-sm-6 product">
								<div class="item_border item-product">
									...
									<div class="wrapper_content">
										...
										<span class="post_date">Day tour</span>
										<div class="description">
											<p>Amankutan - one of the most picturesque corners of Uzbekistan. It is located in the western spur of the Zarafshan and other ranges in the basin. Amankutan, 40 km south-west of Samarkand.  </p>
										</div>
									</div>
									<div class="read_more">
										<div class="item_rating">
